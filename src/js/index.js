...
// 쪼개서 한 번에 한 개씩 구현할 수 있도록
/** TODO 메뉴 추가
 * [x] 메뉴 이름을 입력하고 확인 버튼을 누르면 메뉴가 추가된다.
 * [x] 메뉴 이름을 입력하고 엔터키 입력으로 추가한다.
 ...
 * TODO 메뉴 수정
 * [x] 메뉴의 수정 버튼을 누르면 메뉴 이름을 수정하는 모달창이 뜬다.
 * [x] 모달창에서 새 메뉴명을 입력 받고 확인 버튼을 누르면 메뉴가 수정된다.

 * TODO 메뉴 삭제
 * [x] 메뉴 삭제 버튼을 누르면 confirm 모달창이 뜬다.
 * [x] 모달창의 확인 버튼을 누르면 메뉴가 삭제된다.
 * [x] 총 메뉴 갯수를 count하여 상단에 보여준다.
 */
